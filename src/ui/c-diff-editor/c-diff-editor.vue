...
monaco.editor.defineTheme('ToolHaven-dark', {
  base: 'vs-dark',
  inherit: true,
  rules: [],
  colors: {
...
monaco.editor.defineTheme('ToolHaven-light', {
  base: 'vs',
  inherit: true,
  rules: [],
  colors: {
...
watch(
  ...
  isDarkTheme => monaco.editor.setTheme(isDarkTheme ? 'ToolHaven-dark' : 'ToolHaven-light'),
  { immediate: true },
);
