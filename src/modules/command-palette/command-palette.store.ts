...
export const useCommandPaletteStore = defineStore('command-palette', () => {
  ...
  const searchOptions: PaletteOption[] = [
    ...
    },
    {
      ...
      href: 'https://github.com/Sleepyico/ToolHaven',
      category: 'External',
      description: 'View the source code of ToolHaven on Github.',
      keywords: ['github', 'repo', 'repository', 'source', 'code'],
      icon: GithubIcon,
    },
    {
      name: 'Report a bug or an issue',
      description: 'Report a bug or an issue to help improve ToolHaven.',
      href: 'https://github.com/Sleepyico/ToolHaven/issues/new/choose',
      category: 'Actions',
    ...
    {
      name: 'About',
      description: 'Learn more about ToolHaven.',
      to: '/about',
      category: 'Pages',
